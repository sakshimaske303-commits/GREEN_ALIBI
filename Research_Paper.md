...
![Figure 1](outputs/figures/fig.jpeg)

**Figure 1.** Location of the study area. (a) Maharashtra state within India. (b) Marathwada division within Maharashtra. (c) The eight constituent districts of Marathwada, with Latur district highlighted for reference.
...
![Figure 2](outputs/figures/boundary_overlay_check.png)

**Figure 2.** Verification of boundary masking: clipped SIF data (color) overlaid with the true Marathwada district boundary (blue outline), confirming that raster values are correctly excluded outside the study region.
...
![Figure 3](outputs/figures/sif_vs_ndvi_seasonal_v2.png)

**Figure 3.** Normalized SIF and NDVI seasonal trajectories, Marathwada, 2015 (drought), 2018 (drought), and 2020 (normal monsoon). SIF's decline from seasonal peak precedes NDVI's decline in all three years.
...
![Figure 4](outputs/figures/sif_ndvi_lag_by_threshold.png)

**Figure 4.** SIF-to-NDVI decline lag (days), by decline threshold and year.
...
![Figure 5](outputs/figures/sif_spatial_comparison_doy273_v2.png)

**Figure 5.** Spatial SIF distribution, day-of-year 273, 2015/2018/2020, masked to the precise Marathwada boundary.

![Figure 6](outputs/figures/sif_by_district_static.png)

**Figure 6.** Mean SIF by district, day-of-year 273, 2015/2018/2020.
...
![Figure 7](outputs/figures/rainfall_anomaly_2015_2018_2020.png)

**Figure 7.** Regional rainfall anomaly (% departure from 2001–2020 climatological mean), by year.
...
![Figure 8](outputs/figures/rainfall_anomaly_by_district_static.png)

**Figure 8.** Rainfall anomaly by district (% departure from regional 20-year normal), 2015/2018/2020.
...
![Figure 9](outputs/figures/combined_sif_rainfall_comparison.png)

**Figure 9.** SIF (top row) and rainfall anomaly (bottom row) by district, 2015/2018/2020, presented jointly for direct spatial comparison.
