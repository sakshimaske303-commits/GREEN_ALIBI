...
SIF's post-peak drop preceded NDVI's post-peak drop in seven of the eight years (2015, 2016, 2017, 2019, 2020, 2022, 2023) — consistent with its physical basis as a more immediate stress signal. That direction is confirmed independently by cross-correlation, and by bootstrap resampling showing SIF never trailing NDVI in a single replicate across those seven years (100% of 2,000 replicates, every year). Three independent methods agree that 2018 breaks the pattern: a marginally negative threshold-crossing lag, a cross-correlation lag of exactly zero, and only 8.1% of bootstrap replicates showing a positive lag.
...
Similar to the original 3-year study, mean lag was smaller in the two drought years (7.6 days) than in the six normal years (15.0 days) — this data does not support H3. The exact year-to-year ranking is itself sensitive to the method used, and flagged as non-robust (see Research Paper §4.6); the bootstrap check (§4.7) confirms it isn't statistically distinguishable from noise across any of the 28 pairwise comparisons among this sample's eight years.
